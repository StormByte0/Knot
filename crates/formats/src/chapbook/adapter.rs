//! Chapbook stub adapter — returns None for all methods.
//!
//! Chapbook uses `state` for variable access. This stub is a placeholder
//! until Chapbook-specific translation is implemented.
...
/// Chapbook's stub implementation of `VirtualDocAdapter`.
pub struct ChapbookAdapter;

impl VirtualDocAdapter for ChapbookAdapter {
