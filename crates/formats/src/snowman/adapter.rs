//! Snowman stub adapter — returns None for all methods.
//!
//! Snowman uses `window.story.state` for variable access. This stub is
//! a placeholder until Snowman-specific translation is implemented.
...
/// Snowman's stub implementation of `VirtualDocAdapter`.
pub struct SnowmanAdapter;

impl VirtualDocAdapter for SnowmanAdapter {
